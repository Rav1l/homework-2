...
public typealias OpenAPIClient = RickAndMortyAPI

open class RickAndMortyAPI {
...
open class RequestBuilder<T> {
    ...
    required public init(method: String, URLString: String, parameters: [String: Any]?, headers: [String: String] = [:], requiresAuthentication: Bool) {
        ...
        addHeaders(RickAndMortyAPI.customHeaders)
    }
    ...
    @discardableResult
    open func execute(_ apiResponseQueue: DispatchQueue = RickAndMortyAPI.apiResponseQueue, _ completion: @escaping (_ result: Swift.Result<Response<T>, ErrorResponse>) -> Void) -> RequestTask {
        return requestTask
    }
    ...
    open func addCredential() -> Self {
        credential = RickAndMortyAPI.credential
        return self
    }
}
